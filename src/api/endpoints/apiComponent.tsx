...
//     // États pour les variables supplémentaires
...
const ApiComponent: React.FC<ApiComponentProps> = ({
    ...
    // États pour les variables, initialisés avec les props si disponibles
    ...
    return (
        <div style={styles.container}>
            ...
            <div style={styles.inputGroup}>
                ...
                {/* Sélecteur ou champ en lecture seule pour STATUT */}
                {propStatut ? (
                    <input
                        type="text"
                ...
                {/* Sélecteur ou champ en lecture seule pour PUB */}
                {propPub ? (
                    <input
                        type="text"
                ...
                {/* Sélecteur ou champ en lecture seule pour CPF */}
                {propCpf ? (
                    <input
                        type="text"
                ...
                {/* Sélecteur ou champ en lecture seule pour taille */}
                {propTaille ? (
                    <input
                        type="text"
