            ...
            <Grid container spacing={2}>
                <Grid item xs={12} sm={6}>
                    <TextField
                        ...
                        defaultValue="Ancienne activité secondaire"
                        variant="outlined"
                        InputProps={{
                            readOnly: !editable
                        }}
                ...
                <Grid item xs={12} sm={6}>
                    <TextField
                        ...
                        defaultValue="Ancien statut secondaire"
                        variant="outlined"
                        InputProps={{
                            readOnly: !editable
                        }}
                ...
                <Grid item xs={12} sm={6}>
                    <TextField
                        ...
                        defaultValue="Ancienne profession secondaire"
                        variant="outlined"
                        InputProps={{
                            readOnly: !editable
                        }}
                ...
                <Grid item xs={12} sm={6}>
                    <TextField
                        ...
                        defaultValue="Ancienne nomenclature PCS secondaire"
                        variant="outlined"
                        InputProps={{
                            readOnly: !editable
                        }}
                ...
                <Grid item xs={12} sm={6}>
                    <TextField
                        ...
                        defaultValue="Ancienne nomenclature ISCO secondaire"
                        variant="outlined"
                        InputProps={{
                            readOnly: !editable
                        }}
