...
export const Route = createFileRoute("/$enquete/formation/expert/logement/$logementDetails/$index")({
    component: () => {
        // eslint-disable-next-line react-hooks/rules-of-hooks
        const match = useMatch("/$enquete/formation/expert/logement/$logementDetails/$index");
